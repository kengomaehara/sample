...
<h3>数学科なんでも掲示板</h3>
<h1>エントリーシート・適性検査・GD</h1>

<form action="mission_3_ES.php" method="post">
  コメント<br />
...
$tableName2 = mission3_ES;//テーブルの指定
