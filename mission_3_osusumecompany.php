...
<form action="mission_3_osusumecompany.php" method="post">
  コメント<br />
...
$tableName = mission3_osusumecompany;
//データ入力
//プリペアドステートメントの利用
...
$tableName2 = mission3_osusumecompany;//テーブルの指定
...
$tableName3 = mission3_osusumecompany;
// データをを変数に格納
